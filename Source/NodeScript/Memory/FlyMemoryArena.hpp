...
namespace FLY_NAMESPACE
{
	...
	public:
		...
		void* AllocateSize(std::size_t size);
	...
	template<size_t BufferCapacity>
	inline void* MemoryArena<BufferCapacity>::AllocateSize(const std::size_t size)
	{
