...
namespace CLX
{
    ...
    [[nodiscard]] inline std::vector<EntityID> GetEntityDescendants(const ECS& ecs, const EntityID entityID)
    {
        ...
        {
            const auto& grandChildren = GetEntityDescendants(ecs, child);
